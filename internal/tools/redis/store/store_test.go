...
func TestSetExpiry(t *testing.T) {
	...
	s.Set("mykey", store.StoreValue{Data: "value", ExpiresAt: nil})
	...
	s.Set("override", store.StoreValue{Data: "val", ExpiresAt: &expiry})
	...
	s.Set("temp", store.StoreValue{Data: "val", ExpiresAt: nil})
	...
	s.Set("immediate", store.StoreValue{Data: "val", ExpiresAt: nil})
